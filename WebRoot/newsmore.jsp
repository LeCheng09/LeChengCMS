  ...
  <body>
    ...
    <div id="layout">
      ...
      <div id="header">
        ...
        <div id="search">
          ...
          <fieldset>
            <input type="text" id="phrase" name="phrase" value="搜索网站" onfocus="if(this.value=='搜索网站')this.value=''" />
    ...
    <div id="footer">
      <div id="foot">
        ...
        <p class="f-left">&copy; 2008 &ndash; 2012 乐成科技版权所有</p>
        <p class="f-right">京 ICP备11011334号-1   京公网安备110105007294 | Powered by: <a href="#">乐成科技09班</a></p>
      </div>
    </div>
